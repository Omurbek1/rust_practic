fn main() {
   let float_32_bit_variable: f32 = 3.14;
   let _float_64_bit_variable: f64 = 3.14;
    println!("float_32_bit_variable: {}", float_32_bit_variable);
    println!("float_64_bit_variable: {}", _float_64_bit_variable);
